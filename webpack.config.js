...
module.exports = () => {
  ...
  const commonConfig = {
    ...
    entry: {
      index: path.resolve(__dirname, './client/js/pages/index/index.js'),
      signin: path.resolve(__dirname, './client/js/pages/signIn/signIn.js'),
      signup: path.resolve(__dirname, './client/js/pages/signUp/signUp.js'),
      verification: path.resolve(__dirname, './client/js/pages/verification/verification.js'),
      resetpassword: path.resolve(__dirname, './client/js/pages/resetpassword/resetPassword.js'),
      userdash: path.resolve(__dirname, './client/js/pages/userdash/userDash.js'),
      userprofile: path.resolve(__dirname, './client/js/pages/userprofile/userProfile.js'),
      courtregistration: path.resolve(__dirname, './client/js/pages/courtregistration/courtRegistration.js'),
      admindash: path.resolve(__dirname, './client/js/pages/admindash/adminDash.js'),
      courtreservations: path.resolve(__dirname, './client/js/pages/courtreservations/courtReservations.js'),
      eventtournaments: path.resolve(__dirname, './client/js/pages/event&tournaments/event&Tournaments.js'),
      viewuserpayment: path.resolve(__dirname, './client/js/pages/viewuserpayment/viewUserPayment.js'),
      usercourtlist: path.resolve(__dirname, './client/js/pages/usercourtlist/userCourtList.js'),
      usercourtviewing: path.resolve(__dirname, './client/js/pages/usercourtviewing/userCourtViewing.js'),
      usercourtreservation: path.resolve(__dirname, './client/js/pages/usercourtreservation/userCourtReservation.js')
    },
    output: {
